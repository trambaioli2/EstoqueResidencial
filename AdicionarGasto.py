...
class AdicionarGasto:
    def __init__(self, master=None):
        ...
        self.label4 = Label(self.conteiner3, text='Quantidade de Gasto: ', width=25, font=self.fonte)
        self.label4.pack(side=LEFT)
        self.gasto = Spinbox(self.conteiner3, width=25, font = self.fonte, from_=0.0, to=10000.0, increment=1.0)
        self.gasto.pack(side=LEFT)

        self.conteiner4 = Frame(master, padx=40, pady=30)
        self.conteiner4.pack()
        self.botao = Button(self.conteiner4, text='Adicionar Gasto', font=self.fonte, width=18, command=self.adgasto)
